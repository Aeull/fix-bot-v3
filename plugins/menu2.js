...
await conn.send3ButtonImg(m.chat, thumb, info, '*NOTE🚨*:⌕Kalo Ada Yang Error Harap Dimaklumi⌕', '𝐋𝐢𝐬𝐭𝐦𝐞𝐧𝐮', '.m all', '𝐃𝐨𝐧𝐚𝐬𝐢', '.donasi', '𝐎𝐰𝐧𝐞𝐫', '.owner', fgif, { contextInfo: { externalAdReply :{
